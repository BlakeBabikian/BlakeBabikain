...
// updated by jd robertson: Fri, Dec 26, 2014
	var html = "";
	html += "<div id='_avatar64'><img src='images/avatar.png' class='_siz64'></div>";
	html += "<div id='_name'>";
	html += "<div id='_firstname'>Blake</div>";
	html += "<div id='_lastname'>Babikian</div>";
	html += "<div id='_shortname'>bbabikian</div>";
	html += "</div>";
	...
	html = "";
	html += "<span id='_avatar32'><img src='images/avatar.png' class='_siz32'></span>";
	html += "<span id='_course'>CS380</span>";
	html += "<span id='_semester'>Bentley University Fall 2023/span>";
	...
	foot.onmouseout =
		function () {
			var obj = document.getElementById("_avatar32");
			obj.innerHTML = "<img src='images/avatar.png' class='_siz32'>";
			obj = document.getElementById("_date");
			var date = dateStandard() + " " + julianDate() + " " + browserType().toUpperCase();
			obj.innerHTML = date;
